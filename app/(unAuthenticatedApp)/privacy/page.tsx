  ...
  return (
    <ComponentWrapper>
      <h1 className='text-3xl font-bold mb-4'>
        ...
        <br />
        <span>Effective Date 19-Jan-2024</span>
      </h1>

      <p className='privacy-policy-p'>
        This Privacy Policy describes the policies of WordPress Security, Dhaka,
        Mirpur 1216, Bangladesh, email: mdpabel385@gmail.com, phone:
        +8801761442268 on the collection, use and disclosure of your information
        that we collect when you use our website (wordpresssecurities.com). (the
      ...
      <ol className='privacy-policy-ol'>
        ...
        <li>
          ...
          <p className='privacy-policy-p'>
            We will retain your personal information with us for 0 day or for as
            long as we need it to fulfill the purposes for which it was
            collected as detailed in this Privacy Policy. We may need to retain
            certain information for longer periods such as record-keeping /
            reporting in accordance with applicable law or for other legitimate
            reasons like enforcement of legal rights, fraud prevention, etc.
            Residual anonymous information and aggregate information, neither of
            which identifies you (directly or indirectly), may be stored
            indefinitely.
          </p>
        </li>
        ...
        <li>
          ...
          <p className='privacy-policy-p'>
            ...
            exercise these rights, you can write to us at mdpabel385@gmail.com.
        ...
        <li>
          ...
          <p className='privacy-policy-p'>
            ...
            <a href='wordpresssecurities.com/cookie-policy'>Cookie Policy.</a>
          </p>
        </li>
        ...
        <li>
          ...
          <p className='privacy-policy-p'>
            ...
            Officer at WordPress Security, Dhaka, email: mdpabel385@gmail.com.
