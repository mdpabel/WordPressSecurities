  ...
  return (
    <details>
      <summary
        {...props}
        className={cn(
          "list-none py-3 cursor-pointer after:content-['+'] after:absolute after:right-0 after:text-2xl after:font-semibold transition duration-500 after:transition after:transform after:duration-300",
          props.className,
        )}>
        {children}
      </summary>
...
const AccordionContent = ({ children, ...props }: Accordion) => {
  return <div className='font-normal content'>{children}</div>;
};
